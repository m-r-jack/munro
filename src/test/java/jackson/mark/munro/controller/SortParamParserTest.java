...
class SortParamParserTest {
    ...
    private static final String HEIGHT_DESCENDING_SPECIFIER = "-height";
    private static final String HEIGHT_ASCENDING_SPECIFIER = "+height";
    private static final String NAME_DESCENDING_SPECIFIER = "-name";
    private static final String NAME_ASCENDING_SPECIFIER = "+name";
    private static final String HEIGHT_DESC_THEN_NAME_DESC_SPECIFIER = "-height,-name";
    private static final String HEIGHT_DESC_THEN_NAME_ASC_SPECIFIER = "-height,+name";
    private static final String NAME_ASC_THEN_HEIGHT_DESC_SPECIFIER = "+name,-height";
    private static final String NAME_ASC_THEN_HEIGHT_ASC_SPECIFIER = "+name,+height";
